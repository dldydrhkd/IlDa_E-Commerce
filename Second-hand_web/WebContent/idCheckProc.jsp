...
boolean cnt = dao.duplicateIdCheck(id); 
...
%> 
<script> 
function apply(id){ //2) 중복확인 id를 부모창에 적용 //부모창 opener 
...
%> 
<hr> <a href="javascript:history.back()">[다시시도]</a> &nbsp; &nbsp; 
